...
***** TODO Fonction modifié pour des liens autre que "id"
:LOGBOOK:
...
******* TODO La db pour stocker tout cela (temporaire avec vulpea, je vais pas aller rajouter une colonne dans celle d'org-roam... quoique)
:LOGBOOK:
