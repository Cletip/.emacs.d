...
******* CANCEL Creation of the type of link
...
******* TODO La db pour stocker tout cela (temporaire avec vulpea, je vais pas aller rajouter une colonne dans celle d'org-roam... quoique). Au final, inutile car je fais les choses du type id1:id2, donc pas besoin de rajouter quelque chose au niveau de la dblocks
:LOGBOOK:
...
******* CANCELED Modifier la fonction pour insérer des liens dans la db (pour insérer dans la table lien : type = id du lien, et valeur = id de la note)
      ...
      (let ((type (org-element-property :type link))
        ...
        (when (and source path)
          (if (and (boundp 'org-ref-cite-types)
            ...
            ;;modifier ici avec un "if" pour permettre de savoir si l'id 1
