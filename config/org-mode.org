...
***** Gestion de la dernière date de modification 
...
****** Voir plus de choses dans l'agenda (org-agenda-log-mode)

[[https://stackoverflow.com/questions/56228430/display-scheduled-routines-actual-done-time-in-agenda-view][vient d'ici]]

On voit : quand c'est fini, clock et les states
